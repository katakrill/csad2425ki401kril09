...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_DEVICE_INTERFACE   (0x0Au)
...
#define CY_BLE_DEVICE_INTERFACE_IN_CHAR_INDEX   (0x00u) /* Index of In characteristic */
#define CY_BLE_DEVICE_INTERFACE_OUT_CHAR_INDEX   (0x01u) /* Index of Out characteristic */


#define CY_BLE_DEVICE_INTERFACE_SERVICE_HANDLE   (0x0010u) /* Handle of Device Interface service */
#define CY_BLE_DEVICE_INTERFACE_IN_DECL_HANDLE   (0x0011u) /* Handle of In characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_IN_CHAR_HANDLE   (0x0012u) /* Handle of In characteristic */
#define CY_BLE_DEVICE_INTERFACE_OUT_DECL_HANDLE   (0x0013u) /* Handle of Out characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_OUT_CHAR_HANDLE   (0x0014u) /* Handle of Out characteristic */
